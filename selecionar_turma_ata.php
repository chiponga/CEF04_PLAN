...
<script async src="config.js"></script>
        ...
        <title>Selecionar Turma Ata</title>
    ...
    <body class="app">
        ...
        <div class="mobile-menu md:hidden">
            ...
            <li>
                    ...
                    <li>
                        <a href='selecionar_turma_ata.php' class="menu">
                            <div class="menu__icon"> <i data-feather="file-text"></i> </div>
                            <div class="menu__title"> Ata de conselho </div>
                        </a>
                    </li>
                    <?php if($origem =="Dir"){?>
                    <li>
                    ...
                    <li>
                                <a href="javascript:;" class="menu">
                                    ...
                                    <div class="menu__title"> Relatórios <i data-feather="chevron-down" class="side-menu__sub-icon"></i> </div>
                                </a>
                                <ul class="">
                                    <li>
                                        <a href="selecionar_digitado.php" class="menu">
                                            <div class="menu__icon"> <i data-feather="zap"></i> </div>
                                            <div class="menu__title">Alunos sem Carteirinha</div>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#" class="menu">
                                            <div class="menu__icon"> <i data-feather="zap"></i> </div>
                                            <div class="menu__title">Alunos sem uniforme</div>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="selecionar_atrasos.php" class="menu">
                                            <div class="menu__icon"> <i data-feather="zap"></i> </div>
                                            <div class="menu__title">Atrasos</div>
                                        </a>
                                    </li>
                                </ul>
                            </li>
        ...
        <div class="flex">
            ...
            <nav class="side-nav">
                ...
                <ul>
                    ...
                    <?php }?>
                    <li>
                        <a href='selecionar_turma_ranking.php' class="side-menu">
                            <div class="side-menu__icon"> <i data-feather="file-text"></i> </div>
                            <div class="side-menu__title"> Ranking </div>
                        </a>
                    </li>

                    <li>
                        <a href='numero_alunos.php' class="side-menu">
                            <div class="side-menu__icon"> <i data-feather="file-text"></i> </div>
                            <div class="side-menu__title"> Número de alunos </div>
                        </a>
                    </li>
                    ...
                    <?php if($origem =="Dir"){?>
                    <li>
                        <a href='tela_horario.php' class="side-menu">
                            <div class="side-menu__icon"> <i data-feather="file-text"></i> </div>
                            <div class="side-menu__title"> Horário</div>
                        </a>
                    </li>
                    <?php }?>
            ...
            <div class="intro-y box" style="width: 70%; margin-top: 50px">
                            ...
                            <div class="div">
                            <div class="mt-2"> 
							<form method="post" action="registrar_obs.php">
