...
$sql=("SELECT * FROM `avisos` WHERE escola = '$escola' AND Turma = '0'");
                    ...
                    <div class="flex flex-col lg:flex-row border-b border-gray-200 dark:border-dark-5 pb-5 -mx-5">
                        <div class="flex flex-1 px-5 items-center justify-center lg:justify-start">
                            <div class="w-20 h-20 sm:w-24 sm:h-24 flex-none lg:w-32 lg:h-32 image-fit relative">
                                <img class="rounded-full" src="http://135.148.160.173/5s6d4f56sdf1s56a1f3s2f1s32af1s32df1s32df1ds561f/<?php echo $_SESSION['codigo'];?>.JPG" >
             ...
             <div class="col-span-12">
              ...
              <div style=" display: flex;justify-content: center;" class="intro-y overflow-auto lg:overflow-visible mt-8 sm:mt-0">
                  <table style="width: 90%" class="table table-report sm:mt-2">
                      <thead>
                          <tr >
                              <th class="whitespace-no-wrap">Titulo</th>
                      ...
                      <?php while ($rows = mysqli_fetch_assoc($query)) {?>
                        <form method="post" action="ver_aviso.php" id="">
                          <tr class="intro-x">
                              <td class="text-center">
                                  <span style="font-size: 17px;font-weight: 700;"><?php echo $rows['Assunto'];?></span>
                              </td>
                              ...
                              <td class="table-report__action w-56">
                                  ...
                                  <input type="hidden" name="Aviso" value=<?php echo $rows['Id']?>>
                                  <button type="submit" <?php echo ' data-aviso="'.$rows['Id'].'" ' ?> id="ver"><div class="flex items-center justify-center text-theme-9"> <i data-feather="check-square" class="w-4 h-4 mr-2"></i> Ver </div></button>                                          
                                  </div>
                              </td>
                          </tr>
                          </form>
