...
<script async src="config.js"></script>
	...
	<meta charset="utf-8">
	<title>Bloquar aluno</title>
	<meta name="viewport" content="width=device-width, initial-scale=1">

	
	<link rel="stylesheet" href="http://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css">
	<link rel="stylesheet" type="text/css" href="dist_provisorio/assets/css/styles.css">
    <link rel="stylesheet" type="text/css" href="dist_provisorio/assets/css/demo.css">
    ...
    <script type="text/javascript">
            ...
            function dia_ate(){
               ...
               // window.document.getElementById("#dia_ano").value = 'Nenhum';
				...
				$("#ano_ate").val( $('option:contains("2019")').val() );
                }
...
<body>
	...
	<div class="container">
		...
		<div class="creditCardForm">
			...
			<div class="payment">
				<form method="post" action="validar_bloqueio.php">
					...
					<div class="form-group" id="pay-now">
						<a href='aluno_professor.php' class="btn btn-default">Voltar</a>
					</div>
				</form>
			</div>
		</div>
