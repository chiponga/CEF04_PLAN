  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
      	...
      	<img id="img_modal" src="https://admbv.com.br/Fotos/<?php echo $rows_cursos['Codigo']; ?>.JPG" height="80%"  width="90%"  onerror="this.onerror=null; this.src='/imagens/semFoto.png'">
		...
		<a href="selecionar_turma.php" class="botao red">Outra turma</a>
					...
					<form action="" method="post">
						<?php while($rows_cursos = mysqli_fetch_assoc($resultado_cursos)){ ?>
									...
									<img  onclick="pegarId(<?php echo $rows_cursos['Codigo']; ?>)"  class="img" data-toggle="modal" data-target="#exampleModal" id="<?php echo $rows_cursos['Aluno']; ?>" src="https://admbv.com.br/Fotos/<?php echo $rows_cursos['Codigo']; ?>.JPG"height="140px" style="margin: 20px" width="120px" onerror="this.onerror=null; this.src='/imagens/semFoto.png'">
...
$('#img_modal').attr('src','https://admbv.com.br/Fotos/'+codigo+'.JPG')
