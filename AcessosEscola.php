...
$sql_count=("SELECT COUNT(*) FROM `entrada` WHERE Codigo = '$codigo'");
            ...
            <div style=" display: flex;justify-content: center;margin-top: 50px">
             ...
             <div style="width: 90%;padding: 20px"class="intro-y box px-5 pt-5 mt-5">
                    <div class="flex flex-col lg:flex-row border-b border-gray-200 dark:border-dark-5 pb-5 -mx-5">
						...
						<div class="flex mt-6 lg:mt-0 items-center lg:items-start flex-1 flex-col justify-center text-gray-600 dark:text-gray-300 px-5 border-l border-r border-gray-200 dark:border-dark-5 border-t lg:border-t-0 pt-5 lg:pt-0">
                            <div style="font-size: 17px;font-weight: 700;" class="truncate ls:whitespace-normal flex items-center"><a href="AcessosEscolaSaida.php" class="btn2 blue">Saída</a></div>
                  ...
                  <table style="width: 90%" class="table table-report sm:mt-2">
                      <thead >
                          <tr >
                              ...
                              <th class="text-center whitespace-no-wrap">Entrada</th>
                      ...
                      <?php while ($rows = mysqli_fetch_assoc($query)) {?>
                          ...
                          <?php if($rows['Atrasos'] == "1"){?>
                              <td class="w-40" style="background-color: red;">
                                  <div class="flex">
                                      <div class="text-center" ><span style="font-size: 15px;font-weight: 600;color: white ">
                                      <?php if(true){?>
                                          <?php echo $rows['Dia']; ?>
                                       <?php }?>
                                       </span></div>
                              ...
                              <td class="text-center" style="background-color: red;">
                                  <span style="font-size: 17px;font-weight: 700;color: white"><?php echo $rows['Horas'];?></span>
                              </td>
