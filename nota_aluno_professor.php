			  ...
			  <div style="background: #fff;width: 80%;padding: 20px"class="intro-y box px-5 pt-5 mt-5">
                    <div class="flex flex-col lg:flex-row border-b border-gray-200 dark:border-dark-5 pb-5 -mx-5">
                        <div class="flex flex-1 px-5 items-center justify-center lg:justify-start">
							...
							<img class="rounded-md intro-y" src="http://135.148.160.173/5s6d4f56sdf1s56a1f3s2f1s32af1s32df1s32df1ds561f/<?php echo $codigo;?>.JPG" onerror="this.onerror=null; this.src='imagens/semFoto.png'">
